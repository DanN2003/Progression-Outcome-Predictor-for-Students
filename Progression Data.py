...
def save_to_file(progression_data, filename="progression_data.txt", save_path="C:\Users\accou\OneDrive\Desktop"): #change file path if needed
...
def load_from_file(filename="progression_data.txt", load_path="C:\Users\accou\OneDrive\Desktop"): #change file path if needed
    progression_data = []
